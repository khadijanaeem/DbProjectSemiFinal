<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="WebAppEHR.WebForm2" %>
...
<p>Welcome to Al-Shifa's Pharmacy, where your health and well-being are our top priorities. As an integral part of Al-Shifa, our pharmacy plays a crucial role in providing high-quality care and medication services to our patients. Location: 27-H Model Town, lhr.</p>
  ...
  <%--  <section id="appointment" class="appointment section-bg">
   ...
   <form id="myForm" runat="server" action="/main.aspx" method="post">
    <div class="form-group">
        <input type="text" id="nameField" runat="server" class="form-control" placeholder="Your Name" required />
    </div>
    <div class="form-group">
        <input type="email" id="emailField" runat="server" class="form-control" placeholder="Your Email" required />
    </div>
    <div class="form-group">
        <input type="date" id="appointmentDateField" runat="server" class="form-control" placeholder="Appointment Date" required />
    </div>
        <div class="form-group">
       <asp:DropDownList ID="departmentSelectField" runat="server" CssClass="form-control" required>
    ...
    <div class="form-group">
        <select id="doctorSelectField" runat="server" class="form-control" required>
    ...
    <div class="form-group">
        <textarea id="messageField" runat="server" class="form-control" name="message" rows="5" placeholder="Message" required></textarea>
    </div>
    <div class="text-center">   
